...
namespace LAB_1
{
    class Program
    {
        class MethInf
        {
            ...
            internal void Upd_Meth_Info(int arg)
            {
                ++overloads;
        ...
        static void StartMenu()//по умолч обл вид namespace
        {
            Console.WriteLine(@"
...
Нажмите 0 для выхода в главное меню:");
        ...
        static void All_About_Methods(Type t)
        {
            ...
            for (int i = 0; i < methods.Length; ++i)
            {
                ...
                {
                    s_dic[methods[i].Name].Upd_Meth_Info(methods[i].GetParameters().Length);
                }
            }
